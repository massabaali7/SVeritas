...
def build_model(model, config):
    if model == 'ECAPA2':
        ...
        model = MFA_Conformer(model_location = config['device'], ckpt = "/ocean/projects/cis220031p/mbaali/sv_benchmark/epoch=97_cosine_eer=0.83.ckpt", lr=0.0045, needs_gradients=config["requires_grad"])
