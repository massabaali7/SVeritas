...
class NES(nn.Module):
    ...
    def forward(self, x, x_tgt, y):
        ...
        for i in range(num_batches):
            ...
            eval_y = None
            eval_tgt = x_tgt.repeat(self.samples_per_draw_batch_size+1 if i==0 else self.samples_per_draw_batch_size, 1, 1)
            ...
            scores, loss, _, decisions = self.EOT_wrapper(eval_input, eval_tgt, eval_y)
